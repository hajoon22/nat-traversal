...
int main(void) {
    ...
    nts.stun_port = 19302;
    nts.method = nt_method_spoof_udp_local;
    ...
    spkt.daddr = ntohl(inet_addr("1.1.1.1")); // dst public address
    spkt.dlocal = ntohl(inet_addr("10.10.1.2")); // dst local address
    spkt.data = "hello!";
    spkt.data_len = 6;
